...
public final class SimulationWorld implements World {
    ...
    public void update() {
        ...
        public void findEntities (Collection < Entity > output,int x, int y, int width, int height,
        boolean excludeTouching, boolean excludeNonColliding){
        ...
        public double calculateDistance ( int x1, int y1, int width1, int height1, int x2, int y2, int width2,
        int height2){
