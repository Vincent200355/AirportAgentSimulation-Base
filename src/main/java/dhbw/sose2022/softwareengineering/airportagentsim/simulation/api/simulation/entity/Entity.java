...
public abstract sealed class Entity permits MovingEntity, StaticEntity {
	...
	public final void setPosition(Point pos) {
		...
		Validate.isTrue(canMoveTo(this.world, pos.getX(), pos.getY(), this.width, this.height),
	...
	public final void setWidth(int width) {
		...
		if (!isSpawned())
			throw new IllegalStateException("The entity has not been spawned yet");
		Validate.isTrue(canMoveTo(this.world, this.posX, this.posY, width, this.height),
				"Entity position is blocked by another entitiy");
	...
	public final void setHeight(int height) {
		...
		if (!isSpawned())
			throw new IllegalStateException("The entity has not been spawned yet");
		Validate.isTrue(canMoveTo(this.world, this.posX, this.posY, this.width, height),
				"Entity position is blocked by another entitiy");
